...
return array(
  'ctlstatus'             => array(
    ...
    'reset_instructions'  => 'Инструкции по замене пароля отправлены вам на email.',
    'new_password'        => 'Мы отправили новый пароль на ваш e-mail.',
  ),
  ...
  'mail'                  => array(
    ...
    'reset_instructions'  => array(
      ...
      'link'              => 'Чтобы сменить пароль перейдите по :l0ссылке:l1.',
    ),
    'new_password'        => array(
  ...
  'reset'                 => array(
    ...
    'legend'              => 'Инструкции по смене пароля будут отправлены на указанный email.',
    'submit'              => 'Отправить',
  ),
